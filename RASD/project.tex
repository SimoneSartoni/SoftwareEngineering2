...
\item {[R26]}	\label{R26}The system must allow an agent to login, inserting its ID and password, blocking the registration if the data inserted is not correct.
\end{itemize}
...
\item {[R39]}	\label{R39}The system must allow a supervisor to login, inserting its ID and password,blocking the registration if the data inserted is not correct.
\end{itemize}
