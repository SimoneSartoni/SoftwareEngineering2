...
\centering
\includegraphics[width=.4\linewidth]{mockups/phoneschermatainiziale.png}
\caption[Mockup for the App]{Mobile App mockup for the starting page after having opened the app for a User}
\label{fig:initial-page}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{mockups/Schermata_principale.png}
...
\begin{minipage}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{mockups/Register.png}
\caption[Web mockup for suggestions page]{Web interface mockup for the suggestions list for a logged Municipality Supervisor}
\label{fig:register-page}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{mockups/loginscreen.png}
\caption[Web mockup for suggestions page]{Web interface mockup for the suggestions list for a logged Municipality Supervisor}
...
\begin{minipage}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{mockups/Report.png}
\caption[Web mockup for suggestions page]{Web interface mockup for the suggestions list for a logged Municipality Supervisor}
\label{fig:report-page}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{mockups/Checkstatistics.png}
\caption[Web mockup for suggestions page]{Web interface mockup for the suggestions list for a logged Municipality Supervisor}
...
09-11-2019 & 2h & General revision, tables 1.1 and 3.1\\
\bottomrule
\end{tabular}
