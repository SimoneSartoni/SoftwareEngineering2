...
\begin{table}[H]  
  ...
  \begin{tabular}{|c|c|}
    ...
    \textbf{Requirements} 
    \end{large}\\  \hline
    User Mobile App &  \\ \hline
    MunicipalityAgent Web App & \\ \hline
    MunicipalitySupervisor Web App & \\ \hline
    AccessManager & \\ \hline
    ReportManager & \\ \hline
    SuggestionManager & \\ \hline
    StatisticsManager & \\ \hline
    NotifcationManager & \\ \hline
    DataCollectionManager & \\ \hline
    DataWareHouse & \\ \hline
...
\item The system must allow an agent to discard a violation if it has been verified as fake or it cannot be verified (the vehicle is not there anymore) or it is a duplicated report: //TODO
